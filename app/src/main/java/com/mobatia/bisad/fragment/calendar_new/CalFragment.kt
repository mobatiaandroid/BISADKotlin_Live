...
class CalFragment : Fragment() {
    ...
    private fun initializeUI() {
        ...
        showBtn = requireView().findViewById(R.id.showBtn) as TextView
        hideBtn = requireView().findViewById(R.id.hideBtn) as TextView
        noEventTxt = requireView().findViewById(R.id.noEventTxt) as TextView
        noEventImage = requireView().findViewById(R.id.noEventImage) as ImageView
        ...
        previousBtn = requireView().findViewById(R.id.previousBtn)
        nextBtn = requireView().findViewById(R.id.nextBtn)
        filterLinear = requireView().findViewById(R.id.filterLinear)
        //calendar_relative = view!!.findViewById(R.id.calendar_relative)
        hidePast = requireView().findViewById(R.id.hidePast)
